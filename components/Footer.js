...
function Footer() {
    return (
        <div id="contact" className="h-28 bg-gradient-to-b from-black to-emerald-900 text-white grid grid-cols-2">
            <div className="flex flex-col mt-5 text-xs md:text-base ml-10">
                <p>Napisz do mnie:</p>
